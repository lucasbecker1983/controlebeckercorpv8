...
export const env = {
    ...
    externalPingIp: process.env.EXTERNAL_PING_IP || '8.8.8.8',
    externalPingLabel: process.env.EXTERNAL_PING_LABEL || 'Google DNS',
    wanProviderName: process.env.WAN_PROVIDER_NAME || 'Nicknetwork',
